 ...
 * @LastEditTime: 2023-08-03 17:15:58
...
// 头像内容处理
func touxiangshe_1(_ *model.TblArticle, sections []model.Section) []model.Section {
...
// 背景图内容处理
func touxiangshe_2(_ *model.TblArticle, sections []model.Section) []model.Section {
...
// 壁纸内容处理
func touxiangshe_3(_ *model.TblArticle, sections []model.Section) []model.Section {
...
// 表情包内容处理
func touxiangshe_4(_ *model.TblArticle, sections []model.Section) []model.Section {
